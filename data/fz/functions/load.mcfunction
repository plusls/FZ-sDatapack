...
#如果版本正确且已安装则开始运行
execute if data storage fz {version: Beta-2.0.1.5} if data storage fz.installed {installed: 1b} run function fz:start
#如果版本不符则更新
execute unless data storage fz {version: Beta-2.0.1.5} run function fz:update
#输出版本信息
